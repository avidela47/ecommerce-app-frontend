...
const stripePromise = loadStripe("pk_test_51MuwTQAySpcCZPyCQ2AbG5KYoX6ChaDEAS8DYp2aeocVhlCdoaAA5kASjzjway8gU5foItQuEVJnhB1s6NKw0Wb100kdoALrKD");
...
function CartPage() {
    ...
    function handleDecrease(product) {
        ...
        if (quantity <= 1) return alert("tiene que tener al menos un producto");
    ...
    return (
        <Container style={{ minHeight: "95vh" }} className="cart-container">
            <Row>
                <Col>
                    <h1 className="pt-2 h3">Carrito de compra</h1>
                    {cart.length === 0 ? (
                        <Alert className="alert" variant="info">Carrito vacio. Agregue productos a su carrito</Alert>
                    ) : (
